...
<head>
    ...
    <title>faculty Dashboard - Request a Book</title>
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td class='center'>
                                                        <a href='faculty-request.php?BookNumber={$row['BookNumber']}&BookName={$row['BookName']}&AuthorName={$row['AuthorName']}&CategoryName={$row['CategoryName']}'>
